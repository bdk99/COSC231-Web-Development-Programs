            ...
            else 
            {
                ...
                if($cconverter==true)
                {
                    ...
                    {                 
                        ...
                        echo "Given the celsius value: ".$carray[$j].", the fahrenheit value would be: ".round($farray[$j],2)."°<br>";
                    }
                }
                else
                {
                    for($j=0; $j<5; $j++)
                    {
                        ...
                        echo "Given the fahrenheit value: ".$farray[$j].", the celsius value would be: ".round($carray[$j],2)."°<br>";
                    }
                }
            }
        }
